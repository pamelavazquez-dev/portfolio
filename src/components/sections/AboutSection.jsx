    ...
    <section id="sobre-mi" className="section sectionTint aboutSection">
      ...
      <div className="sectionText">
        <p>
          ...
          mejorar tanto a nivel tecnico como personal. Trabajo con tecnologias como HTML,
        ...
        <p>
          Ademas, incorporo herramientas de Inteligencia Artificial a mi flujo de trabajo
          para agilizar el desarrollo, optimizar procesos, generar documentacion, explorar
          soluciones y mejorar la productividad, siempre aplicando criterio tecnico y
          validando cada implementacion.
        </p>
        <p>
